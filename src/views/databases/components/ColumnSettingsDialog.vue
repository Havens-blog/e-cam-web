    ...
    <div class="column-settings-content">
      ...
      <div class="columns-container">
        ...
        <div class="column-group">
          ...
          <div class="column-list"><div v-for="col in localColumns" :key="col.key" class="column-item" @click="col.visible = !col.visible"><el-checkbox v-model="col.visible" @click.stop /><span class="column-label">{{ col.label }}</span></div></div>
        </div>
      </div>
    </div>
    <template #footer><el-button @click="$emit('update:visible', false)">取消</el-button><el-button type="primary" @click="handleSave">保存设置</el-button></template>
  </el-dialog>
</template>
...
const handleSave = () => {
  ...
  localStorage.setItem('database-column-settings', JSON.stringify(localColumns.value))
