<template>
  <el-drawer :model-value="visible" :with-header="false" size="50%" :close-on-click-modal="true" class="mongodb-detail-drawer" @update:model-value="$emit('update:visible', $event)">
          ...
          <div class="drawer-header">
            <div class="header-left">
              ...
              <div class="instance-info">
                <div class="instance-type">MongoDB 云数据库</div>
            ...
            <div class="detail-columns">
              <div class="detail-column">
                ...
                <div class="info-list">
                  ...
                  <div class="info-row"><span class="info-label">版本</span><span class="info-value">MongoDB {{ instance.attributes?.engine_version || '-' }}</span></div>
                  <div class="info-row"><span class="info-label">类型</span><span class="info-value">{{ instance.attributes?.db_instance_type || (instance.attributes?.replication_factor ? '副本集' : '单节点') }}</span></div>
              ...
              <div class="detail-column">
                ...
                <div class="info-list">
                  ...
                  <div class="info-row"><span class="info-label">副本集</span><span class="info-value">{{ instance.attributes?.replica_set_name || '-' }}</span></div>
                  <div class="info-row"><span class="info-label">副本数</span><span class="info-value">{{ instance.attributes?.replication_factor || '-' }}</span></div>
...
const getStatusText = (status?: string) => { if (!status) return '-'; const map: Record<string, string> = { running: '运行中', stopped: '已停止' }; return map[status.toLowerCase()] || status }
...
<style lang="scss">
.mongodb-detail-drawer { .el-drawer__body { padding: 0; height: 100%; overflow: hidden; } }
</style>
