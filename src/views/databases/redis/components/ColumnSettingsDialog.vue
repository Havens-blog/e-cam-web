...
const handleConfirm = () => { emit('update:columns', localColumns.value); localStorage.setItem('redis-column-settings', JSON.stringify(localColumns.value)); emit('update:visible', false) }
