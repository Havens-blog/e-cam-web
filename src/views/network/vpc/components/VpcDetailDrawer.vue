          ...
          <template v-if="activeTab === 'detail'">
            <div class="detail-columns">
              ...
              <div class="detail-column">
                ...
                <div class="info-list">
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">{{ instance.attributes?.share_type || '私有' }}</span>
                  </div>
                  <div class="info-row">
              ...
              <div class="detail-column">
                ...
                <div class="info-list">
                  <div class="info-row">
                    <span class="info-label">IPv4网段</span>
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">{{ instance.attributes?.nat_gateway_count || 0 }}</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label">外网访问</span>
                    <span class="info-value">{{ instance.attributes?.enable_internet_access ? '启用' : '禁用' }}</span>
                  </div>
                  <div class="info-row">
                  ...
                  <div class="info-row">
                    <span class="info-label">云订阅</span>
                    <span class="info-value">{{ instance.attributes?.subscription || '-' }}</span>
                  </div>
                  <div class="info-row">
...
async function loadSecurityGroups() {
  ...
  try {
    ...
    // N2-001：安全组列表加载失败不再静默吞错，保留清空逻辑的同时给出可见反馈
    ElMessage.error(error?.message || '加载安全组列表失败')
