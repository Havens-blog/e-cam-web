      ...
      <div class="columns-container">
        <div class="column-group">
          ...
          <div class="column-list fixed">
            <div class="column-item disabled"><el-checkbox :model-value="true" disabled /><span class="column-label">云盘ID/名称</span><span class="column-tag">必选</span></div>
...
const defaultColumns: ColumnConfig[] = [
  ...
  { key: 'category', label: '云盘类型', width: 100, visible: true },
  { key: 'instance', label: '挂载实例', width: 150, visible: true },
...
const handleSave = () => {
  ...
  localStorage.setItem('disk-column-settings', JSON.stringify(localColumns.value))
