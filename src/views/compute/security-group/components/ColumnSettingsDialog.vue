      ...
      <div class="columns-container">
        <div class="column-group">
          ...
          <div class="column-list fixed">
            <div class="column-item disabled"><el-checkbox :model-value="true" disabled /><span class="column-label">安全组ID/名称</span><span class="column-tag">必选</span></div>
...
const defaultColumns: ColumnConfig[] = [
  ...
  { key: 'vpc', label: 'VPC', width: 150, visible: true },
...
const handleSave = () => {
  ...
  localStorage.setItem('security-group-column-settings', JSON.stringify(localColumns.value))
