...
const handleConfirm = () => { emit('update:columns', localColumns.value); localStorage.setItem('elasticsearch-column-settings', JSON.stringify(localColumns.value)); emit('update:visible', false) }
