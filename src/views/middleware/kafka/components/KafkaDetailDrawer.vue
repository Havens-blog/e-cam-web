<template>
  <el-drawer :model-value="visible" :with-header="false" size="50%" :close-on-click-modal="true" class="kafka-detail-drawer" @update:model-value="$emit('update:visible', $event)">
          ...
          <div class="drawer-header">
            <div class="header-left">
              ...
              <div class="instance-info">
                <div class="instance-type">Kafka 消息队列</div>
            ...
            <div class="detail-columns">
              <div class="detail-column">
                ...
                <div class="info-list">
                  ...
                  <div class="info-row"><span class="info-label">版本</span><span class="info-value">{{ instance.attributes?.version || '-' }}</span></div>
              ...
              <div class="detail-column">
                ...
                <div class="info-list">
                  <div class="info-row"><span class="info-label">规格</span><span class="info-value">{{ instance.attributes?.spec_type || instance.attributes?.instance_type || '-' }}</span></div>
                  <div class="info-row"><span class="info-label">Topic数量</span><span class="info-value">{{ instance.attributes?.topic_num || '-' }}</span></div>
                  <div class="info-row"><span class="info-label">分区数量</span><span class="info-value">{{ instance.attributes?.partition_num || '-' }}</span></div>
                  <div class="info-row"><span class="info-label">存储容量</span><span class="info-value">{{ instance.attributes?.disk_size || '-' }} GB</span></div>
                  <div class="info-row"><span class="info-label">接入点</span><span class="info-value">{{ instance.attributes?.endpoint || '-' }}</span></div>
...
<style lang="scss">
.kafka-detail-drawer { .el-drawer__body { padding: 0; height: 100%; overflow: hidden; } }
</style>
